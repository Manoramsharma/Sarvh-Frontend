...
const useStyles = makeStyles(theme => ({
  ...
  btn: {
    ...
    fontSize: 18,
    margin: 0,
    [theme.breakpoints.down("sm")]: { fontSize: 10, width: "10%" },
    color: "#C4C4C4",
  },
  socialLinks: {
    display: "flex",
    ...
    marginTop: "3%",
    [theme.breakpoints.down("sm")]: { flexWrap: "wrap", width: "35vw" },
  },
}));
  ...
  return (
    <div className={classes.footer} style={{ zIndex: 1251 }}>
      <div className={classes.footerInside}>
        <Typography gutterBottom className={classes.edit} variant="h5">
          SHOP
        </Typography>
      ...
      <div className={classes.footerInside}>
        ...
        <div className={classes.socialLinks}>
          <Button className={classes.edit1} className={classes.btn}>
            <InstagramIcon className={classes.edit1} />
          </Button>
          <Button className={classes.edit1} className={classes.btn}>
            <LinkedInIcon className={classes.edit1} />
          </Button>
          <Button className={classes.edit1} className={classes.btn}>
            <FacebookIcon className={classes.edit1} />
          </Button>
          <Button className={classes.edit1} className={classes.btn}>
            <TwitterIcon className={classes.edit1} />
          </Button>
        </div>
      </div>
    </div>
